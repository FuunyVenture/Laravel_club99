...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <p class="invoice-address"> This privacy policy discloses the privacy practices for (IWANTADEAL.COM). This privacy policy applies solely to information collected by this web site. It will notify you of the following:
            ...
            <p class="completed-invoice">Information Collection, Use, and Sharing</p>
            <p class="invoice-address"> We are the sole owners of the information collected on this site. We only have access to/collect information that you voluntarily give us via email or other direct contact from you. We will not sell or rent this information to anyone.
            ...
            <p class="completed-invoice">Updates</p>
            <p class="invoice-address">Our Privacy Policy may change from time to time and all updates will be posted on this page.
            </p>
        </div>
    </div>
@endsection
