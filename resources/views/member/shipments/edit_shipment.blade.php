...
@section('content')
    {{--open form--}}
    <form action="{{url('member/shipments/' . $shipment->id)}}" method="POST" novalidate>
        {{method_field('PUT')}}
        {{csrf_field()}}
        <div class="content">
            <div class="row">
                ...
                {{--end content header--}}
                {{--main content-the member can edit shipments--}}
                <div class="col-xs-12">
                    <div class="new-box">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-4 col-lg-1 padding-tb5 completed-invoice">
                                        <label for="status">Status: Pending approval</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7 col-xs-offset-5 padding-tb5 completed-invoice">
                                                {{$shipment->delivery_details->state}}
                                            </div>
                                            <div class="col-xs-7 col-xs-offset-5 padding-tb5 completed-invoice">
                    ...
                    <div class="col-xs-12">
                        ...
                        <a href="{{ url('member/shipments/'.$shipment->id) }}" class="os-regular size50">Cancel</a>
                    </div>
                </div>
                {{--end main content--}}
            </div>
