...
<div class="row confirmation">
    <div class="col-md-10 col-md-offset-2">
        <div class="row">
            <h3>Please confirm these details are correct</h3>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-7 purchase-details">
                ...
                <table id="data_table" class="table datatable dt-responsive" style="width:100%; border-bottom:1px solid grey;">
                    <thead>
                    <tr>
                        <th>Qty</th>
                        <th>Description</th>
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-2 col-md-5 col-lg-4 costs-box os-semibold size44"><h4>Shipment costs</h4>
                <div class="row">
                    <div class="col-xs-8 text-right">Total duty:</div>
                    <div class="col-xs-4 text-left" id="confirmation-duty"></div>
                </div>
                <div class="row">
                    <div class="col-xs-8 text-right">Total VAT{{ '@' . getSetting('VAT_TAX') }}%:</div>
