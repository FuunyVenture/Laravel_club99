    ...
    <div class="content">
        ...
        <div class="row" id="profile-app">
            <div class="col-xs-12 col-centred">
                @if(isset($user))
                    <form action="{{url('/admin/users/'.$user->id)}}" method="POST" novalidate>
                        {{method_field('PUT')}}
                        @else
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 profile-form-container">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <div class="row">
                                                    <label class="col-md-3 control-label" for="textinput">Home
                                                        number: </label>
                                                    <div class="col-md-9">
                                                        <input id="home_number" name="home_number" type="text"
                                                               placeholder="home number"
                                                               class="form-control input-md"
                                                               value="{{old('home_number', isset($user) && isset($user->home_address) ? ($user->home_address->home_number ? $user->home_address->home_number : '') : '')}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="mobile_number" name="mobile_number" type="text"
                                                               ...
                                                               class="form-control input-md"
                                                               value="{{old('mobile_number', isset($user) && isset($user->home_address) ? ($user->home_address->mobile_number ? $user->home_address->mobile_number : '') : '')}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input id="address_line1" name="address_line1"
                                                                               ...
                                                                               value="{{old('address_line1', isset($user) && isset($user->home_address) ? ($user->home_address->address1 ? $user->home_address->address1 : '') : '')}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                                <div class="row">
                                                                    <div class="col-md-offset-3 col-md-9">
                                                                        <input id="address_line2" name="address_line2"
                                                                               ...
                                                                               value="{{old('address_line2', isset($user) && isset($user->home_address) ? ($user->home_address->address2 ? $user->home_address->address2 : '') : '')}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input id="city" name="city" type="text"
                                                                               ...
                                                                               class="form-control input-md"
                                                                               v-model="city"
                                                                               value="{{old('city', isset($user) && isset($user->home_address) ? ($user->home_address->city ? $user->home_address->city : '') : '')}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input id="zipcode" name="zipcode" type="text"
                                                                               ...
                                                                               class="form-control input-md"
                                                                               v-model="zipcode"
                                                                               value="{{old('zipcode', isset($user) && isset($user->home_address) ? ($user->home_address->zip_code ? $user->home_address->zip_code : '') : '')}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            @if(isset($user) && isset($user->subscription) && $user->subscription->status == 'pending')
                                                <div class="col-xs-12 col-md-6">
                                                        ...
                                                        <div class="col-md-12 form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9 completed-forms">
                                                                    <select id="package-select" name="package_id">
                                                                        @foreach($packages as $package)
                                                                            <option value="{{$package->id}}"
                                                                                    cost="{{$package->cost}}"
                                                                                    cost_per="{{$package->cost_per}}"
                                                                                    @if($user->subscription->package->id == $package->id) selected @endif>
                                                                                {{$package->name}}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9 completed-forms" id="package-cost">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9 completed-forms">
                                                                    <input type="text"
                                                                           value="{{old('receipt_code', $user->subscription->store_payment->code)}}"
                                                                           placeholder="Code" name="receipt_code"
                                                                           required/>
                                                                </div>
                                                            </div>
                                                        </div>
