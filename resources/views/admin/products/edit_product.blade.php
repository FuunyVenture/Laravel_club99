...
@section('content')
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 padding-bottom"><h3>Edit Product</h3></div>
        </div>
        {{--end header content--}}
        {{--open form to edit the details of a product--}}
        <form method="POST" action="{{url('/admin/products/' . $fee->id)}}" novalidate>
            {{method_field('PUT')}}
            {{csrf_field()}}
            {{--main content--}}
                                ...
                                <div class="input-group flex">
                                    <div class="col-xs-12">
                                        <input id="name" type="text" class="form-control" name="name"
                                               value="@if(old('name')){{old('name')}}@else{{$fee->name}}@endif"
                        ...
                        <div class="row padding-bottom">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="input-group flex">
                                    ...
                                    <div class="col-xs-11">
                                        <input id="price" class="form-control" type='number' name="cost" step='0.01'
                                               value="@if(old('cost')){{old('cost')}}@else{{$fee->cost}}@endif"
                                ...
                                <div class="radio">
                                    <label class="control-label">
                                        <input type="radio" name="taxable" value="taxable"
                                               @if(!old('taxable') && $fee->taxable == 'taxable')checked="checked"
                                               @elseif(old('taxable')=='taxable')checked="checked" @endif
                                ...
                                <div class="radio">
                                    <label class="control-label">
                                        <input type="radio" name="taxable" value="none"
                                               @if(!old('taxable') && $fee->taxable == 'none')checked="checked"
                                               @elseif(old('taxable')=='none')checked="checked" @endif
                                               style="margin-top: -5px;">
                                        <strong>None</strong>
                                    </label>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <a class="os-bold size50" href="{{url('admin/products/' . $fee->id . '/delete')}}">
                        Delete product
                    </a>
