{{--This is the second step of the shipment where admin can add items--}}
<h3 style="text-align:center">Add items in shipment</h3>
<div class="add-item">
    <div class="row">
                    ...
                    <div class="col-xs-9 col-md-5">
                        <div class="input-group flex">
                            ...
                            <div class="col-md-11 flex input-error">
                                <input id="cost" type="text" class="form-control" name="cost" placeholder="0.00" min="0"
                                       max="100000" required>
                            </div>
                        </div>
                    </div>
